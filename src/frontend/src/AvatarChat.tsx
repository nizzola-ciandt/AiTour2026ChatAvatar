...
function AvatarChat({ userData, onEndConversation }: AvatarChatProps) {
    useEffect(() => {
        document.title = "CI&T - Azure Voice Live Avatar Agent";
    }, []);
    ...
    const handleEndConversation = useCallback(() => {
        const confirmed = window.confirm(
            "Deseja realmente encerrar a conversa? Você será redirecionado para a tela inicial."
        );
        if (confirmed) {
            // Limpar recursos
            teardownMic();
    ...
    }, [teardownMic, teardownAvatar, onEndConversation]);
